...
<div class="container mt-5">
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                @forelse ($siswa->jawabanTugas as $index => $jawaban)
                <tr>
                    <td class="text-center align-middle">{{ $loop->iteration }}</td>
                    <td class="text-center align-middle">{{ $jawaban->tugas->mapel->nama_mapel }}</td>
                    <td class="text-center align-middle">{{ $jawaban->tugas->no_tugas }}</td>
                    <td class="text-center align-middle">{{ $jawaban->nilai_tugas }}</td>
                </tr>
                @empty
                <tr>
