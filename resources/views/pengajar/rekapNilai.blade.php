@extends('lyout/nilai.rekapnilaipeng')
...
<div class="card rekapNilai">
    <div class="card-body kiri">
      ...
      <p><a href="/rekapNilai/siswa" class="btn btn-info masuk-btn " style="margin-top: 12px">Masuk</a></p>
    </div>
  </div>
  <div class="card rekapNilai">
    <div class="card-body kiri">
      ...
      <p><a href="/rekapNilai/ujian/siswa" class="btn btn-info masuk-btn " style="margin-top: 12px">Masuk</a></p>
    </div>
  </div>
