...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/csspengajar/stylerekapN.css') }}">
  ...
  <div class="container-fluid">
    ...
    <div class="sidebar">
      <ul class="menu">
        ...
        <li class="item"><a href="#"><i class='bx bx-book-open' ></i><span class="text"> Ujian</span></a></li>
        ...
        <li  class="item"><a>
          ...
          <li class="profile"><a href="#">      
            <div class="foto">
              <img src="{{ asset('gambar/caca.jpg') }}" alt="">
            </div></a>
    ...
    <main>
      ...
      <div class="info-page"> 
        <nav class="navbar navbar-expand navbar-light bg-white  static-top shadow  ">
          ...
          <!-- Topbar Search -->
          <h1 style="margin-left: 2%"> {{ $title }}</h1>
      
      </nav>  
      </div>

      <div class="konten-nilaiSiswa">
     
        @yield('konten')
      </div>
      <footer>
        <div class="foot">
            @2024. Pengurus Kursus DLWI 
        </div>
    </footer>
    </main>
