...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/cssmurid/styleUjian_murid.css') }}">
  ...
  <div class="container-fluid">
    ...
    <div class="sidebar">
      <ul class="menu">
        ...
        <li class="item"><a href="/MuriMapel"><i class='bx bx-library'></i><span class="text">Materi</span></a></li>
    ...
    <main>
      ...
      <div class="info-page"> 
        <nav class="navbar navbar-expand navbar-light bg-white  static-top shadow  ">
          ...
          <!-- Topbar Search -->
          <h1 style="margin-left: 2%">Draft Ujian</h1>
      
      </nav>  
      </div>

      <div class="konten-draft">
