    ...
    <div class="container mt-2">
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar  static-top shadow">
                ...
                <!-- Topbar Search -->
                <h1 style="margin-left: 4%">{{ $title }}</h1>
                <div class="palidasi">
                    @if (session('success'))
...
<!-- Include the custom notif.js file -->
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <symbol id="check-circle-fill" fill="currentColor" viewBox="0 0 16 16">
      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.293 9.707a1 1 0 0 0 1.414 0L8 8.414l2.293 2.293a1 1 0 0 0 1.414-1.414l-3-3a1 1 0 0 0-1.414 0l-3 3a1 1 0 0 0 0 1.414z"/>
    </symbol>
    <symbol id="exclamation-triangle-fill" fill="currentColor" viewBox="0 0 16 16">
      <path d="M8 0c4.418 0 8 3.582 8 8s-3.582 8-8 8-8-3.582-8-8 3.582-8 8-8zm.93 4.418-1.173 5.467h2.486L8.93 4.418zM8 12a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
    </symbol>
  </svg>
